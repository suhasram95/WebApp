...
<div id="header">
<h1>
<font size="5" color="#4d4d69">Create Braod Band Request</font>
</h1>
</div>

<div id="headerone">
<h2>
<font size="5" color="#4d4d69">Enter the details to create Braod band Request</font>
 </h2>
</div>
...
Product &#160;&#160;&#160;&#160;&#160;<select name="product">
  <option value="SELECT">--Select Broad Band --</option>
  <option value="DIGITAL TV">Weekly</option>
  <option value="BROADBAND">Monthly</option>
  <option value="PAYMENT">Yearly</option>
  </select><br>
